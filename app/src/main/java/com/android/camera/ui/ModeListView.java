...
public class ModeListView extends FrameLayout
    ...
    private void initializeModeSelectorItems() {
        ...
        for (int i = 0; i < mTotalModes; i++) {
            ...
            android.util.Log.e("zyq","ModeListView : modeId = "+modeId);
    ...
    private int getModeIndex(int modeSelectorIndex) {
        if (modeSelectorIndex < mTotalModes && modeSelectorIndex >= 0) {
            android.util.Log.e("zyq","ModeListView : modeSelectorIndex = "+modeSelectorIndex);
                ...
                public void onAnimationEnd(Animator animation) {
                    ...
                    post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            android.util.Log.e("zyq","111 = "+selectedItem.getModeId()+",222 = "+modeId);
