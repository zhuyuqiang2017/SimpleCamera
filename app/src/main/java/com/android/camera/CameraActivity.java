...
import com.appends.JniUtils.JniTest;
...
//        Log.d(new Log.Tag("zyq"),"JNI message = "+ JniTest.stringFromJNI());
    ...
    private void openModule(CameraModule module) {
        module.setCaptureLayoutHelper(getCameraAppUI().getCaptureLayoutHelper());
