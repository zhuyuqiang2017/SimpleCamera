...
import com.appends.feature.FeatureController;
import com.appends.module.BlurModule;
import com.appends.module.ManualModule;
...
public class ModulesInfo {
    ...
    public static void setupModules(Context context, ModuleManager moduleManager,
        ...
        if(FeatureController.isSupportBrokenMode()){
            registerBlurModule(moduleManager, context.getResources().getInteger(R.integer.camera_mode_blur), SettingsScopeNamespaces.BLUR,
                    true);
        }

        if(FeatureController.isSupportManualMode()){
            registerManualModule(moduleManager, context.getResources().getInteger(R.integer.camera_mode_manual), SettingsScopeNamespaces.MANUAL,
                    true);
        }
    }

    private static void registerManualModule(ModuleManager moduleManager, final int moduleId, final String namespace, final boolean enableCaptureModule) {
    ...
    private static void registerBlurModule(ModuleManager moduleManager, final int moduleId, final String namespace, final boolean enableCaptureModule) {
        moduleManager.registerModule(new ModuleManager.ModuleAgent() {
