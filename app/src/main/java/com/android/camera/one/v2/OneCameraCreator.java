...
public class OneCameraCreator {
    ...
    public static OneCamera create(
        ...
        return cameraFactory.createOneCamera(new AndroidCameraDeviceProxy(device),
                ...
                captureSetting.getCameraEffectSetting(),
                captureSetting.getCameraSceneSetting(),
                captureSetting.getCameraAwbSetting(),
                captureSetting.getCameraShadingSetting(),
                captureSetting.getCameraEdgeSetting(),
