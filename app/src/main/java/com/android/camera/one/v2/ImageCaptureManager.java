...
public class ImageCaptureManager extends CameraCaptureSession.CaptureCallback implements
    ...
    public void onCaptureProgressed(CameraCaptureSession session, CaptureRequest request,
        ...
        android.util.Log.e("zyq","ImageCaptureManager : onCaptureProgressed = "+partialResult.getFrameNumber());
    ...
    public void onImageAvailable(ImageReader reader) {
        ...
        android.util.Log.e("zyq","ImageCaptureManager : onImageAvailable");
        if (img != null) {
