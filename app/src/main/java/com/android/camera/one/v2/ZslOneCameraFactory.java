...
public class ZslOneCameraFactory implements OneCameraFactory {
    ...
    public OneCamera createOneCamera(final CameraDeviceProxy device,
            ...
            final Observable<Integer> cameraEffectSetting,
            final Observable<Integer> cameraSceneSetting,
            final Observable<Integer> cameraAwbSetting,
            final Observable<Integer> cameraShadingSetting,
            final Observable<Integer> cameraEdgeSetting,
