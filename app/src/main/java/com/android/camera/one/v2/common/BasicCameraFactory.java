...
public class BasicCameraFactory {
    ...
    public BasicCameraFactory(Lifetime lifetime,
            ...
            Observable<Integer> effect,
            Observable<Integer> scene,
            Observable<Integer> awb,
            Observable<Integer> shading,
            Observable<Integer> edge,
        ...
        requestTemplate.setParam(
              CaptureRequest.CONTROL_EFFECT_MODE,effect);
        requestTemplate.setParam(
              CaptureRequest.CONTROL_MODE,CaptureRequest.CONTROL_MODE_USE_SCENE_MODE);
        requestTemplate.setParam(
              CaptureRequest.CONTROL_SCENE_MODE,scene);

        requestTemplate.setParam(
                CaptureRequest.CONTROL_AWB_MODE,awb);

        requestTemplate.setParam(
                CaptureRequest.SHADING_MODE,shading);

        requestTemplate.setParam(
                CaptureRequest.EDGE_MODE,edge);
        ...
        SafeCloseable cameraEffectCallback = effect.addCallback(mPreviewUpdater, MoreExecutors
                .sameThreadExecutor());
        lifetime.add(cameraEffectCallback);

        SafeCloseable cameraSceneCallback = scene.addCallback(mPreviewUpdater, MoreExecutors
                .sameThreadExecutor());
        lifetime.add(cameraSceneCallback);

        SafeCloseable cameraAwbCallback = awb.addCallback(mPreviewUpdater, MoreExecutors
                .sameThreadExecutor());
        lifetime.add(cameraAwbCallback);

        SafeCloseable cameraShadingCallback = shading.addCallback(mPreviewUpdater, MoreExecutors
                .sameThreadExecutor());
        lifetime.add(cameraShadingCallback);

        SafeCloseable cameraEdgeCallback = edge.addCallback(mPreviewUpdater, MoreExecutors
                .sameThreadExecutor());
        lifetime.add(cameraEdgeCallback);
