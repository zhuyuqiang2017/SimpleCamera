...
public class Keys {
    ...
    public static final String KEY_CAMERA_EFFECT_MODE = "pref_camera_effect_mode_key";

    public static final String KEY_CAMERA_SCENE_MODE = "pref_camera_scene_mode_key";

    public static final String KEY_CAMERA_AWB_MODE = "pref_camera_awb_mode_key";
    public static final String KEY_CAMERA_SHADING = "pref_camera_shading_key";
    public static final String KEY_CAMERA_EDGE = "pref_camera_edge_key";
    ...
    public static void setDefaults(SettingsManager settingsManager, Context context) {
        ...
        settingsManager.setDefaults(KEY_CAMERA_AWB_MODE, context.getResources().getInteger(R.integer.camera_setting_awb_auto_value),
            context.getResources().getIntArray(R.array.camera_setting_awb_entryValues));

        settingsManager.setDefaults(KEY_CAMERA_EFFECT_MODE, context.getResources().getInteger(R.integer.camera_setting_effect_none_value),
            context.getResources().getIntArray(R.array.camera_setting_effect_entryValue));

        settingsManager.setDefaults(KEY_CAMERA_SCENE_MODE, context.getResources().getInteger(R.integer.camera_scene_disable_value),
            context.getResources().getIntArray(R.array.camera_setting_scene_entryValue));

        settingsManager.setDefaults(KEY_CAMERA_SHADING,context.getResources().getInteger(R.integer.camera_setting_shading_off_value),
                context.getResources().getIntArray(R.array.camera_setting_shading_entryValue));

        settingsManager.setDefaults(KEY_CAMERA_EDGE,context.getResources().getInteger(R.integer.camera_setting_edge_off_value),
                context.getResources().getIntArray(R.array.camera_setting_edge_entryValue));
