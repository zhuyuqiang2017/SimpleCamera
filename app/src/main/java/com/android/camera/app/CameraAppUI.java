...
public class CameraAppUI implements ModeListView.ModeSwitchListener,
    ...
    private final CameraModuleScreenShotProvider mCameraModuleScreenShotProvider =
            new CameraModuleScreenShotProvider() {
                ...
                public Bitmap getScreenShot(int previewDownSampleFactor) {
                    ...
                    android.util.Log.e("zyq","Bitmap.length = "+screenshot.getWidth()+"*"+screenshot.getHeight());
                    return screenshot;
                }
            };
    ...
    public void freezeScreenUntilPreviewReady() {
        ...
        Bitmap bitmap = mCameraModuleScreenShotProvider
                .getScreenShot(DOWN_SAMPLE_RATE_FOR_SCREENSHOT);

        mModeTransitionView.setupModeCover(getBlurBitmap(bitmap));
        mHideCoverRunnable = new Runnable() {
            ...
            public void run() {
                ...
                mModeTransitionView.startAnimation(animation);
            }
        };
        mModeCoverState = COVER_SHOWN;
    }

    private Bitmap getBlurBitmap(Bitmap b){
        Bitmap original = b;
        Bitmap result = Bitmap.createBitmap(original.getWidth(),original.getHeight(),original.getConfig());
        RenderScript rs = RenderScript.create((CameraActivity)mController);
    ...
    public void prepareModuleUI() {
        mController.getCurrentModule().setCaptureLayoutHelper(mCaptureLayoutHelper);
    ...
    public void onModeSelected(int modeIndex) {
        ...
        android.util.Log.e("zyq","CameraAppUI : lastIndex = "+lastIndex+", currentIndex = "+currentIndex);
    ...
    public void resetBottomControls(ModuleController module, int moduleIndex) {
        android.util.Log.e("zyq","resetBottomControls = "+moduleIndex);
