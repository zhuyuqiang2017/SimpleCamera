...
public class ModeOptionsOverlay extends FrameLayout
    ...
    private static final int BOTTOM_RIGHT = Gravity.TOP | Gravity.RIGHT;
    private static final int TOP_RIGHT = Gravity.TOP | Gravity.LEFT;
    ...
    private void checkOrientation(int orientation) {
        ...
        if (isPortrait) {
            ...
            modeOptionsParams.gravity = Gravity.LEFT;
